...
/**
 * POST /merchants handler. Stores merchant information in the database.
 */
...
/**
 * GET /merchants handler. Retrieves merchant information by name provided as a query string.
 */
...
/**
 * GET /merchants/:id handler. Retrieves merchant information by ID passed as a path parameter.
 */
...
/**
 * PATCH /merchants handler. Updates merchant information matching the name passed as a query string.
 */
...
/**
 * PATCH /merchants/:id handler. Updates merchant information by ID passed as a path parameter.
 */
...
/**
 * DELETE /merchants handler. Deletes a merchant from the database using their name passed as a query string.
 */
...
/**
 * DELETE /merchants/:id handler. Deletes a merchant from the database by ID passed as a path parameter.
 */
